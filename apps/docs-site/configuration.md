...
- **[Optimization Guide](/optimization-guide)** - Performance tuning strategies
- **[Features](/features)** - Feature descriptions and usage
- **[Dual HUD Layout](/dual-hud-layout)** - UI improvements and gesture refinements
